            ...
            <div class="main-content">
                <div class="row small-spacing">
                    <div class="col-xs-12">
					  ...
					  <div id="success" class="alert alert-success" role="alert"  style="display:none"> <strong>Done !</strong>  Warm Updated Succesfully. </div>
					  <div id="delsuccess" class="alert alert-success" role="alert"  style="display:none"> <strong>Done !</strong>  Warm Deleted Succesfully. </div>

                        <div class="box-content card white">
                            <h4 class="box-title">Warm Details</h4>
                            <!-- /.box-title -->
							<div class="dropdown js__drop_down">
							 <button type="type" id="btnmultidelete"  class="btn btn-icon btn-icon-right btn-danger btn-xs waves-effect waves-light" style="margin-left:10px;"><i class="ico fa fa-trash"></i> DELETE</button>
                                <a href="add_warm.php" class="btn btn-icon btn-icon-right btn-violet btn-xs waves-effect waves-light"><i class="ico fa fa-plus"></i> Add New</a>
                            </div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Edit Warm Details</h4>
			</div>
			...
			<div class="modal-body">
				                <input type="hidden" value="update" name="action"/>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <select class="form-control input-sm" id="txtdose" name="txtdose">
                                        <?php 	
...
function fill_data(){
	...
	$.ajax({
              ...
              success: function(data) {
					...
					$.each(obj, function() {
					     result += "<tr><td><input type='checkbox'  class='checkboxtable'  name='check[]' value='"+this['warmId']+"' ></td>";
						 result += "<td>"+ this['warmName'] +"</td>";
						 result += "<td>"+ this['pname'] +"</td>";
						 result += "<td><a onClick='updatedata("+this['warmId']+")' class='btn btn-xs btn-info waves-effect waves-light btnupd' data-toggle='modal' data-target='#myModal'><i class='ico fa fa-edit'></i></a> <a onClick='deldata("+this['warmId']+")' class='btn btn-xs btn-danger waves-effect waves-light btndel' data-remodal-target='remodal'><i class='ico fa fa-trash'></i></a></td>";
		...
		$("#tabledata").DataTable();
				...
				function updatedata(s)
				{
					...
					$.ajax({
					  ...
					  var obj = $.parseJSON(data);
					  console.log(obj)
						   $('#txtcid').val(obj[0].warmId);
						   $('#txttitle').val(obj[0].warmName);
						   $('#txtdose').val(obj[0].pestId);
					  }
					  });
