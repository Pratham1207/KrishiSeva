            ...
            <div class="main-content">
                <div class="row small-spacing">
                    <div class="col-xs-12">
					  ...
					  <div id="success" class="alert alert-success" role="alert"  style="display:none"> <strong>Done !</strong>  Pesticide Updated Succesfully. </div>
					  <div id="delsuccess" class="alert alert-success" role="alert"  style="display:none"> <strong>Done !</strong>  Pesticide Deleted Succesfully. </div>

                        <div class="box-content card white">
                            <h4 class="box-title">Pesticide Details</h4>
                            <!-- /.box-title -->
							<div class="dropdown js__drop_down">
							 <button type="type" id="btnmultidelete"  class="btn btn-icon btn-icon-right btn-danger btn-xs waves-effect waves-light" style="margin-left:10px;"><i class="ico fa fa-trash"></i> DELETE</button>
                                <a href="add_Pesticide.php" class="btn btn-icon btn-icon-right btn-violet btn-xs waves-effect waves-light"><i class="ico fa fa-plus"></i> Add New</a>
                            </div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Edit Pesticide Details</h4>
			</div>
			...
			<div class="modal-body">
				                <input type="hidden" value="update" name="action"/>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-sm" id="txtdose" name="txtdose" placeholder="Dose" value="">
                                    </div>
                                     <div class="form-group">
...
function fill_data(){
	...
	$.ajax({
              ...
              success: function(data) {
					...
					$.each(obj, function() {
					     result += "<tr><td><input type='checkbox'  class='checkboxtable'  name='check[]' value='"+this['pestId']+"' ></td>";
						 result += "<td>"+ this['pestName'] +"</td>";
						 result += "<td>"+ this['pestDose'] +"</td>";
						 result += "<td>"+ this['pestDescription'] +"</td>";
						 result += "<td><a onClick='updatedata("+this['pestId']+")' class='btn btn-xs btn-info waves-effect waves-light btnupd' data-toggle='modal' data-target='#myModal'><i class='ico fa fa-edit'></i></a> <a onClick='deldata("+this['pestId']+")' class='btn btn-xs btn-danger waves-effect waves-light btndel' data-remodal-target='remodal'><i class='ico fa fa-trash'></i></a></td>";
		...
		$("#tabledata").DataTable();
				...
				function updatedata(s)
				{
					...
					$.ajax({
					  ...
					  var obj = $.parseJSON(data);
					  console.log(obj)
						   $('#txtcid').val(obj[0].pestId);
						   $('#txttitle').val(obj[0].pestName);
						   $('#txtdose').val(obj[0].pestDose);
						   $('#txtdesc').val(obj[0].pestDescription);
					  }
					  });
