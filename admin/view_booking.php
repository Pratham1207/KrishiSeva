            ...
            <div class="main-content">
                <div class="row small-spacing">
                    <div class="col-xs-12">
					  ...
					  <div id="delsuccess" class="alert alert-success" role="alert"  style="display:none"> <strong>Done !</strong>  Booking remove Succesfully. </div>
	...
	$.ajax({
              ...
              success: function(data) {
                    ...
                    var result="";
                        ...
                        result += "<th>Farmer Name</th>";
                        result += "<th>Cold Store</th>";
					...
					$.each(obj, function() {
						 ...
						 result += "<td>"+ this['startDate'] +"</td>";
						 result += "<td>"+ this['endDate'] +"</td>";
						 result += "<td>"+ this['StoreType'] +"</td>";
						 result += "<td>"+ this['Weight'] +"</td>";
						 result += "<td>"+ this['createDate'] +"</td>";
						 result += "</tr>";
