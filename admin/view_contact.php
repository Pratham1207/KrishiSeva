            ...
            <div class="main-content">
                <div class="row small-spacing">
                    <div class="col-xs-12">
					  ...
					  <div id="success" class="alert alert-success" role="alert"  style="display:none"> <strong>Done !</strong>  contact Updated Succesfully. </div>
					  <div id="delsuccess" class="alert alert-success" role="alert"  style="display:none"> <strong>Done !</strong>  contact Deleted Succesfully. </div>
					  
			
                       
                        <div class="box-content card white">
                            <h4 class="box-title">Contact Inquiry Details</h4>
                            <!-- /.box-title -->
...
function fill_data(){
	...
	$.ajax({
              ...
              success: function(data) {
					...
					$.each(obj, function() {
					     result += "<tr><td><input type='checkbox'  class='checkboxtable' name='check[]' value='"+this['cmid']+"' >";
				
						 result += "<td>"+ this['name'] +"</td>";
						 result += "<td>"+ this['contact'] +"</td>";
						 result += "<td>"+ this['email'] +"</td>";
						 result += "<td>"+ this['msg'] +"</td>";
						 result += "<td><a onClick='deldata("+this['cmid']+")' class='btn btn-xs btn-danger waves-effect waves-light btndel' data-remodal-target='remodal'><i class='ico fa fa-trash'></i></a></td>";
