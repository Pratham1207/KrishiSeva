            ...
            <div class="main-content">
                <div class="row small-spacing">
                    <div class="col-xs-12">
					  ...
					  <div id="delsuccess" class="alert alert-success" role="alert"  style="display:none"> <strong>Done !</strong>  cold store Succesfully. </div>
					  
			
                       
                        <div class="box-content card white">
                            <h4 class="box-title">Cold Storage Details</h4>
                            <!-- /.box-title -->
...
function fill_data(){
	...
	$.ajax({
              ...
              success: function(data) {
					...
					$.each(obj, function() {
					     result += "<tr><td><input type='checkbox'  class='checkboxtable' name='check[]' value='"+this['cId']+"' >";
				
						 result += "<td>"+ this['title'] +"</td>";
						 result += "<td>"+ this['phoneno'] +"</td>";
						 result += "<td>"+ this['emailid'] +"</td>";
						 result += "<td>"+ this['address'] +"</td>";
						 if(this['isactive']=='Y')
						 {
						 result += "<td><a href='javascript:void(0)'  data-id='"+ this['cId'] +"' data-status='N' class='label label-success isaupd'>Yes</a></td>";						 }else{
						 result += "<td><a href='javascript:void(0)'  data-id='"+ this['cId'] +"' data-status='Y' class='label label-danger isaupd'>No</a></td>"; 						  }
						 result += "<td><a onClick='deldata("+this['cId']+")' class='btn btn-xs btn-danger waves-effect waves-light btndel' data-remodal-target='remodal'><i class='ico fa fa-trash'></i></a></td>";
